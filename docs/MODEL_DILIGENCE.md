...
| Vol **point forecast**: log-HAR beats EWMA (30b) | **real-OOS** ✅ | Beats incumbent EWMA: mean OOS R² +0.25 vs +0.20 @1w, +0.21 vs +0.16 @1m (6 commodities); wins NG decisively; never blows up. Shipped **opt-in** (`estimator=har_log`), EWMA stays default | `seeds/validate_estimator_30b.py`, ~10y real, `estimator_skill` |
